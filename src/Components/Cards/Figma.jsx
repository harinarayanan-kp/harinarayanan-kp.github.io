    ...
    return (
        <div className="Frame26" style={{
            ...
            <div className="Group18" style={{
                ...
                <img className="Image6" style={{ width: 100, height: 100, left: 41, top: 41, position: 'absolute' }} src={FigmaIMG} />
            </div>
            ...
            <div className="5Years" style={{ alignSelf: 'stretch', textAlign: 'center', color: 'black', fontSize: 24, fontFamily: 'Montserrat', fontWeight: '600', wordWrap: 'break-word' }}>1.5 years +</div>
